...
trait GameDef {
  ...
  case class Block(b1: Pos, b2: Pos) {
     ...
     */
    def neighbors: List[(Block, Move)] = List((this.right, Right), (this.left, Left), (this.up, Up), (this.down, Down))  
     ...
     */
    def legalNeighbors: List[(Block, Move)] = this.neighbors.filter(z=>z._1.isLegal)
